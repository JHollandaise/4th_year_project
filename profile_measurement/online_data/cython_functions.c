...
static __Pyx_memviewslice __pyx_f_16cython_functions_compute_profile(int, int, int, __Pyx_memviewslice, int __pyx_skip_dispatch); /*proto*/
...
static const char __pyx_k_Fast_Cython_implementation_of_la[] = "Fast Cython implementation of laser line manipulation functions.";
...
static PyObject *__pyx_pf_16cython_functions_compute_profile(CYTHON_UNUSED PyObject *__pyx_self, int __pyx_v_lower_bound, int __pyx_v_upper_bound, int __pyx_v_threshold, __Pyx_memviewslice __pyx_v_image); /* proto */
...
static PyObject *__pyx_pw_16cython_functions_1compute_profile(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static __Pyx_memviewslice __pyx_f_16cython_functions_compute_profile(int __pyx_v_lower_bound, int __pyx_v_upper_bound, int __pyx_v_threshold, __Pyx_memviewslice __pyx_v_image, CYTHON_UNUSED int __pyx_skip_dispatch) {
  int __pyx_v_x;
  int __pyx_v_y;
  int __pyx_v_total_weight;
  unsigned char __pyx_v_value;
  __Pyx_memviewslice __pyx_v_mean_height = { 0, 0, { 0 }, { 0 }, { 0 } };
  ...
  __Pyx_RefNannySetupContext("compute_profile", 0);
 ...
 */
  ...
  __pyx_t_2 = PyInt_FromSsize_t((__pyx_v_image.shape[1])); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 20, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_4 = NULL;
 ...
 */
  __pyx_t_6 = (__pyx_v_mean_height.shape[0]);
  __pyx_t_7 = __pyx_t_6;
 ...
 *             if value > threshold:
 */
    __pyx_t_9 = __pyx_v_upper_bound;
    __pyx_t_10 = __pyx_t_9;
    for (__pyx_t_11 = __pyx_v_lower_bound; __pyx_t_11 < __pyx_t_10; __pyx_t_11+=1) {
 ...
 */
      ...
      __pyx_v_value = (*((unsigned char *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_image.data + __pyx_t_12 * __pyx_v_image.strides[0]) ) + __pyx_t_13 * __pyx_v_image.strides[1]) )));
 ...
 *                 total_weight += value
 */
      __pyx_t_14 = ((__pyx_v_value > __pyx_v_threshold) != 0);
      if (__pyx_t_14) {
 ...
 */
        ...
        *((double *) ( /* dim=0 */ (__pyx_v_mean_height.data + __pyx_t_15 * __pyx_v_mean_height.strides[0]) )) += (__pyx_v_y * __pyx_v_value);
 ...
 */
        __pyx_v_total_weight = (__pyx_v_total_weight + __pyx_v_value);
 ...
 *         elif x>0:
 */
    __pyx_t_14 = ((__pyx_v_total_weight > 0) != 0);
    if (__pyx_t_14) {
 ...
 */
      ...
      *((double *) ( /* dim=0 */ (__pyx_v_mean_height.data + __pyx_t_16 * __pyx_v_mean_height.strides[0]) )) /= __pyx_v_total_weight;
 ...
 */
      ...
      *((double *) ( /* dim=0 */ (__pyx_v_mean_height.data + __pyx_t_18 * __pyx_v_mean_height.strides[0]) )) = (*((double *) ( /* dim=0 */ (__pyx_v_mean_height.data + __pyx_t_17 * __pyx_v_mean_height.strides[0]) )));
 ...
 */
    /*else*/ {
      ...
      *((double *) ( /* dim=0 */ (__pyx_v_mean_height.data + __pyx_t_19 * __pyx_v_mean_height.strides[0]) )) = 0.0;
    }
    __pyx_L8:;
  }
 ...
 *     return mean_height             # <<<<<<<<<<<<<<
 */
  __PYX_INC_MEMVIEW(&__pyx_v_mean_height, 0);
  __pyx_r = __pyx_v_mean_height;
  goto __pyx_L0;
 ...
 */
  ...
  __Pyx_AddTraceback("cython_functions.compute_profile", __pyx_clineno, __pyx_lineno, __pyx_filename);
  goto __pyx_L2;
  __pyx_L0:;
  ...
  __pyx_L2:;
  __PYX_XDEC_MEMVIEW(&__pyx_v_mean_height, 1);
...
/* Python wrapper */
static PyObject *__pyx_pw_16cython_functions_1compute_profile(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static char __pyx_doc_16cython_functions_compute_profile[] = "calculate the mean laser line position between lower_bound and\n    upper_bound.\n    Laser light is considered to be pixels with intensity\n    above threshold.\n    ~1ms per frame\n    ";
static PyObject *__pyx_pw_16cython_functions_1compute_profile(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("compute_profile (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_lower_bound,&__pyx_n_s_upper_bound,&__pyx_n_s_threshold,&__pyx_n_s_image,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_upper_bound)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("compute_profile", 1, 4, 4, 1); __PYX_ERR(0, 8, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_threshold)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("compute_profile", 1, 4, 4, 2); __PYX_ERR(0, 8, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  3:
        if (likely((values[3] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_image)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("compute_profile", 1, 4, 4, 3); __PYX_ERR(0, 8, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "compute_profile") < 0)) __PYX_ERR(0, 8, __pyx_L3_error)
      }
    ...
    __pyx_v_lower_bound = __Pyx_PyInt_As_int(values[0]); if (unlikely((__pyx_v_lower_bound == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 8, __pyx_L3_error)
    __pyx_v_upper_bound = __Pyx_PyInt_As_int(values[1]); if (unlikely((__pyx_v_upper_bound == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 8, __pyx_L3_error)
    __pyx_v_threshold = __Pyx_PyInt_As_int(values[2]); if (unlikely((__pyx_v_threshold == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 8, __pyx_L3_error)
    __pyx_v_image = __Pyx_PyObject_to_MemoryviewSlice_dsds_unsigned_char(values[3], PyBUF_WRITABLE); if (unlikely(!__pyx_v_image.memview)) __PYX_ERR(0, 9, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("compute_profile", 1, 4, 4, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 8, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("cython_functions.compute_profile", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_16cython_functions_compute_profile(__pyx_self, __pyx_v_lower_bound, __pyx_v_upper_bound, __pyx_v_threshold, __pyx_v_image);
...
static PyObject *__pyx_pf_16cython_functions_compute_profile(CYTHON_UNUSED PyObject *__pyx_self, int __pyx_v_lower_bound, int __pyx_v_upper_bound, int __pyx_v_threshold, __Pyx_memviewslice __pyx_v_image) {
  ...
  if (unlikely(!__pyx_v_image.memview)) { __Pyx_RaiseUnboundLocalError("image"); __PYX_ERR(0, 8, __pyx_L1_error) }
  __pyx_t_1 = __pyx_f_16cython_functions_compute_profile(__pyx_v_lower_bound, __pyx_v_upper_bound, __pyx_v_threshold, __pyx_v_image, 0); if (unlikely(!__pyx_t_1.memview)) __PYX_ERR(0, 8, __pyx_L1_error)
...
static PyMethodDef __pyx_methods[] = {
  {"compute_profile", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_16cython_functions_1compute_profile, METH_VARARGS|METH_KEYWORDS, __pyx_doc_16cython_functions_compute_profile},
  {0, 0, 0, 0}
};
...
static struct PyModuleDef __pyx_moduledef = {
    ...
    "cython_functions",
    __pyx_k_Fast_Cython_implementation_of_la, /* m_doc */
  #if CYTHON_PEP489_MULTI_PHASE_INIT
    0, /* m_size */
  #else
    -1, /* m_size */
...
if (!__Pyx_RefNanny) {
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("cython_functions", __pyx_methods, __pyx_k_Fast_Cython_implementation_of_la, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
