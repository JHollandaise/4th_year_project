...
\begin{figure}[ht]
    \begin{subfigure}{0.5\textwidth}
        \centering
        % include first image
        \includegraphics[width=\linewidth]{figures/profile_measure/highres_setup_overview.jpg}  
        %\caption{front}
    ...
    \begin{subfigure}{0.5\textwidth}
        \centering
        % include second image
        \includegraphics[width=\linewidth]{figures/profile_measure/highres_setup_top.jpg}  
        %\caption{top}
